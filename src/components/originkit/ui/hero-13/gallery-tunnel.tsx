...
const DEFAULTS = {
    ...
    lineColor: "#B0B0B0",
    lineOpacity: 0,
    colors: ["#006c49", "#10b981", "#adedd3", "#f3f4f5", "#ffffff"],
    grid: 6,
    speed: 45,
    boost: 90,
    fade: 100,
    ...
    labelFill: "#FFFFFF",
    labelColor: "#000000",
    labelFont: { fontFamily: "Manrope", fontSize: 14, fontWeight: 500 } as CSSProperties,
};
